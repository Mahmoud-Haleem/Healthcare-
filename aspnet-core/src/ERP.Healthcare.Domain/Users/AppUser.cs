...
namespace ERP.Healthcare.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update HealthcareDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update HealthcareEfCoreEntityExtensionMappings to extend the IdentityUser entity
