...
{
    [DbContext(typeof(HealthcareMigrationsDbContext))]
    [Migration("20200727115157_Add_doctorId_Patient")]
    partial class Add_doctorId_Patient
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.Doctor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DoctorMemberships","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DoctorServices","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorShift", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DoctorShifts","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorSpecialty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DoctorSpecialties","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("DoctorTitles","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.Membership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Memberships","Doctor");
                });

            modelBuilder.Entity("ERP.Healthcare.Doctors.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Patients.Patient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.Address", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.City", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.Doctor", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Healthcare.Doctors.DoctorSpecialty", "DoctorSpecialty")
                        .WithMany()
                        .HasForeignKey("DoctorSpecialtyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Healthcare.Doctors.DoctorTitle", "DoctorTitle")
                        .WithMany()
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.DoctorMembership", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.Doctor", "Doctor")
                        .WithMany("DoctorMemberships")
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Healthcare.Doctors.DoctorShift", "DoctorShift")
                        .WithMany()
                        .HasForeignKey("DoctorShiftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ERP.Healthcare.Doctors.Membership", "Membership")
                        .WithMany("DoctorMemberships")
            ...
            modelBuilder.Entity("ERP.Healthcare.Doctors.State", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.Country", "Country")
                        .WithMany("States")
            ...
            modelBuilder.Entity("ERP.Healthcare.Patients.Patient", b =>
                {
                    b.HasOne("ERP.Healthcare.Doctors.Doctor", null)
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
